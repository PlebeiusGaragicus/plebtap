<!-- src/lib/components/plebtap/views/onboarding-view.svelte -->
<script lang="ts">
	import ViewContainer from './view-container.svelte';
	import OrbitingPlebtap from '../animations/orbiting-circles/orbiting-plebtap.svelte';
...
<ViewContainer className="flex flex-col space-y-4 p-2">
	<!-- <AnimatedBeamMultipleInputs /> -->
	<h1>Welcome to Plebtap</h1>
</ViewContainer>
